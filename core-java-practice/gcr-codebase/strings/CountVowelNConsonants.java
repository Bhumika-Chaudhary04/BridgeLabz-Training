package extras;
import java.util.*;
public class CountVowelNConsonants {
	public static void main(String[] args) {
		...
		System.out.println("Frequency of vowel and consonant in the string is : ");
		System.out.println("Number of vowels in string are : "+freq[0]);
		System.out.println("Number of consonants in string are : "+freq[1]);
	}
